...
import { DurationExtractor, ContentMetadata, calculateConsumptionTime } from '../../../server/services/duration-extractor';
import { UnitTestBase } from '../../utils/UnitTestBase';

class DurationExtractorTest extends UnitTestBase {
  constructor() {
    super();
  }
...
describe('Duration Extractor', () => {
  let testInstance: DurationExtractorTest;

  beforeAll(async () => {
    testInstance = new DurationExtractorTest();
